/**
 * 중국 출장검품 서비스 신청서 - Google Apps Script (수정본)
 * 
 * 설치 방법:
 * 1. 이 코드를 새 파일(예: WebApplicationHandler.gs)에 복사
 * 2. MainTranslation.gs의 onOpen 함수에 메뉴 추가 (선택사항)
 * 3. 배포 > 새 배포 > 웹앱으로 배포
...
// 시트 이름 - 새로운 시트를 생성하거나 기존 시트 사용
const SHEET_NAME = '웹신청내역'; // 기존 '설문지 응답 시트1'과 별도로 관리
...
// MainTranslation.gs의 onOpen 함수에 추가할 메뉴 항목 (선택사항)
// .addItem('웹 신청서 테스트', 'testWebApplication') 